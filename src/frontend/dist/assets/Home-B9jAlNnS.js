    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/5 border border-primary/20 rounded-xl p-6 mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-muted-foreground leading-relaxed", children: [
          "Perfect Solution operates a Material Testing Laboratory in Bangalore, currently in process for",
          " ",
...
function RentMachineModal({ open, onClose }) {
  ...
  if (!open) return null;
  const items = activeTab === "civil" ? CIVIL_EQUIPMENT$1 : MECHANICAL_EQUIPMENT$1;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "dialog",
    {
      open: true,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 w-full max-w-2xl max-h-[90vh] flex flex-col bg-card border border-border rounded-2xl shadow-elevated overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 px-6 py-5 border-b border-border bg-navy", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  ...
                  children: "Available Machines for Rent"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-inverse/60 mt-0.5", children: "Contact us to enquire about availability & rates" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex border-b border-border bg-muted/30 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                onClick: () => setActiveTab("civil"),
                className: `flex items-center gap-2 px-5 py-3.5 text-sm font-body font-semibold transition-smooth border-b-2 ${activeTab === "civil" ? "border-accent-teal text-accent-teal bg-accent-teal/5" : "border-transparent text-muted-foreground hover:text-foreground"}`,
                "data-ocid": "rent-tab-civil",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { size: 15 }),
                  "Civil Work Equipment",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "ml-1 bg-accent-teal/15 text-accent-teal border-accent-teal/30 text-[10px] px-1.5 py-0", children: CIVIL_EQUIPMENT$1.length })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `flex items-center gap-2 px-5 py-3.5 text-sm font-body font-semibold transition-smooth border-b-2 ${activeTab === "mechanical" ? "border-accent-teal text-accent-teal bg-accent-teal/5" : "border-transparent text-muted-foreground hover:text-foreground"}`,
                "data-ocid": "rent-tab-mechanical",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { size: 15 }),
                  "Mechanical & Workshop",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "ml-1 bg-accent-teal/15 text-accent-teal border-accent-teal/30 text-[10px] px-1.5 py-0", children: MECHANICAL_EQUIPMENT$1.length })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-y-auto flex-1 p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2.5", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-accent-teal shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-foreground truncate", children: item.name })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 bg-muted/30 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground", children: "For rental enquiries, call us or chat on WhatsApp" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+917869091028", children: "Call Now" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
...
function CompanyProfile() {
  const [rentOpen, setRentOpen] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "company-profile", className: "scroll-mt-24 mb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-navy rounded-2xl overflow-hidden mb-10 geometric-triangle", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 px-8 py-12 md:py-16", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-3xl md:text-5xl font-bold text-inverse leading-tight mb-4 max-w-2xl", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent-teal", children: "Solution" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg text-inverse/70 max-w-xl leading-relaxed mb-8", children: "Your complete design and engineering partner — delivering precision engineering and strategic consultancy since 2018." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              onClick: () => {
                var _a2;
                return (_a2 = document.getElementById("fleet")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
              },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-6 shadow-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground mb-3", children: "About Perfect Solution" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground leading-relaxed mb-4", children: "Perfect Solution is a premier engineering and strategic consultancy firm based in Bhilai, Chhattisgarh, India. Founded in 2018 with a commitment to excellence, we provide comprehensive solutions across civil, structural, mechanical, and infrastructure domains." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(RentMachineModal, { open: rentOpen, onClose: () => setRentOpen(false) })
  ] });
}
...
function FeedbackSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "feedback", className: "scroll-mt-24 mb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground max-w-lg", children: "We value your thoughts. Tell us about your experience with Perfect Solution — your feedback helps us improve." })
    ] }),
...
const INITIAL_VISIBLE$2 = 3;
function EquipmentTable({
  items,
  tabId
}) {
  const [showAll, setShowAll] = reactExports.useState(false);
  const visibleItems = showAll ? items : items.slice(0, INITIAL_VISIBLE$2);
  const remaining = items.length - INITIAL_VISIBLE$2;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm font-body", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: visibleItems.map(({ id, sn, name, qty }, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          "data-ocid": id,
    ...
    items.length > INITIAL_VISIBLE$2 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-4 flex justify-center border-t border-border/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        ...
        children: showAll ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { size: 16 }),
          "View Less"
...
function FleetOfMachines() {
  const [activeTab, setActiveTab] = reactExports.useState("civil");
  const activeData = TABS.find((t) => t.id === activeTab);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "fleet", className: "scroll-mt-24 mb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-body font-semibold uppercase tracking-widest text-accent-teal mb-2", children: "Equipment Inventory" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl md:text-3xl text-foreground mb-3", children: "Fleet of Machines" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground max-w-lg", children: "Our extensive fleet of civil and mechanical equipment ensures we have the right machine for every job — from heavy excavation to precision workshop operations." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pt-6 pb-4 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground", children: "Complete Equipment List" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground mt-0.5", children: "Full inventory of civil & mechanical equipment" })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(EquipmentTable, { items: activeData.data, tabId: activeTab })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-3 bg-muted/30 border-t border-border text-xs font-body text-muted-foreground", children: "Data as per company machinery & manpower details — Perfect Designing Hub, Bhilai." })
        ]
      }
    )
  ] });
...
function Projects() {
  const [showAll, setShowAll] = reactExports.useState(false);
  const visibleProjects = showAll ? PROJECTS : PROJECTS.slice(0, INITIAL_VISIBLE$1);
  const remaining = PROJECTS.length - INITIAL_VISIBLE$1;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "projects", className: "scroll-mt-24 mb-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-5", children: visibleProjects.map((project, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    PROJECTS.length > INITIAL_VISIBLE$1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
...
function Services() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "services", className: "scroll-mt-24 mb-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: visibleServices.map((service) => /* @__PURE__ */ jsxRuntimeExports.jsx(ServiceCard, { service }, service.id)) }),
...
function WhyChooseUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "why-choose-us", className: "scroll-mt-24 mb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl md:text-3xl text-foreground mb-3", children: "Why Perfect Solution?" }),
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FleetOfMachines, {}),
