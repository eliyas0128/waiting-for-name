import { X as createLucideIcon, L as reactExports, _ as jsxRuntimeExports, a4 as Button, aj as Link } from "./index-BUmr5eX5.js";
import { I as Images, B as Badge } from "./badge-9S0LW41U.js";
/**
...
const GALLERY_ITEMS = [
  ...
  // Mechanical Equipment
  {
    ...
    qty: "2 Acre",
    category: "mechanical",
    imageUrl: "https://images.unsplash.com/photo-1565787164707-e69a3e4f2e7c?w=400&h=300&fit=crop"
  },
  {
    id: "g-me-02",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden aspect-[4/3]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
              className: `text-xs font-body font-semibold px-2 py-0.5 border ${item.category === "civil" ? "bg-primary/90 text-primary-foreground border-primary/60" : "bg-secondary/90 text-secondary-foreground border-secondary/60"}`,
              children: item.category === "civil" ? "Civil" : "Mechanical"
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-3 right-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-black/60 text-white text-xs font-body font-semibold px-2 py-0.5 rounded-full backdrop-blur-sm", children: item.qty }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body font-semibold text-sm text-foreground leading-snug line-clamp-2", children: item.name }) })
      ]
    }
  );
}
function GalleryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-b border-border sticky top-0 z-10 shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-lg text-foreground leading-tight truncate", children: "Equipment Gallery" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground", children: [
            GALLERY_ITEMS.length,
            " items — Civil & Mechanical"
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-body font-semibold uppercase tracking-widest text-accent-teal mb-2", children: "Perfect Designing Hub" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground max-w-2xl", children: "A comprehensive visual catalogue of our machinery fleet — from heavy civil earthmoving equipment to precision mechanical workshop machines, powering infrastructure projects across India." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5", children: tabItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(GalleryCard, { item }, item.id)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 pt-6 border-t border-border flex flex-wrap items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-muted-foreground", children: "Machinery fleet — Perfect Solution & PDH Tech Consultancy, Bhilai, Chhattisgarh." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            asChild: true,
