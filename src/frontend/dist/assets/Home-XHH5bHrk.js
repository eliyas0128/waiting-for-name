...
const FAQ_QA = [
  {
    ...
    answer: "PDH Tech Consultancy offers a broad range of engineering services including CHP & Conveyors, Industrial Equipment design, Building & Structural Engineering, Pipeline & Trenchless Solutions, Urban Infrastructure, Pavement Management, Project Management Consultancy (PMC), and BOT/DBFO/PPP Advisory."
  },
  {
    id: "faq-contact",
  ...
  },
  {
    ...
    answer: "Yes! PDH Tech Consultancy is ISO 9001:2015 certified by CDG Certification. We are also registered under MSME (Government of India), Coal India, EPF, ESIC, and hold Workers Compensation Insurance."
  },
  {
    id: "faq-projects",
    question: "How many projects have you completed?",
    answer: "We have successfully completed 50+ projects for 30+ clients since our founding in 2018. Our clients include reputed names like SAIL, Vedanta, SECL, Jindal, and Galaxy Infra."
  },
  {
    id: "faq-about",
    question: "What is PDH?",
    answer: "PDH Tech Consultancy is a premier engineering and strategic consultancy firm founded in 2018, based in Bhilai, Chhattisgarh, India. We are your completing design with engineering partner — ISO 9001:2015 certified with 10+ professionals and 8+ years of experience."
  }
];
const WELCOME_MSG = {
  id: "msg-welcome",
  role: "bot",
  content: "Hello! 👋 I'm the PDH Tech Assistant. How can I help you today? You can ask me about our services, location, certifications, or anything about PDH Tech Consultancy.",
...
function ChatBot() {
  ...
  const [messages, setMessages] = reactExports.useState([WELCOME_MSG]);
  ...
  function handleSend() {
    ...
    for (const faq of FAQ_QA) {
      ...
      if ((lower.includes("where") || lower.includes("location") || lower.includes("address") || lower.includes("office")) && kw.includes("where")) {
        answer = faq.answer;
        break;
      }
      if ((lower.includes("iso") || lower.includes("certified") || lower.includes("certification")) && kw.includes("iso")) {
        answer = faq.answer;
        break;
      }
      if ((lower.includes("project") || lower.includes("complete") || lower.includes("how many")) && kw.includes("project")) {
        answer = faq.answer;
        break;
      }
      if ((lower.includes("what is") || lower.includes("about pdh") || lower.includes("who are")) && kw.includes("what is")) {
        answer = faq.answer;
        break;
      }
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: open ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 20 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { size: 20 })
      }
    ),
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "dialog",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-navy px-4 py-3 flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-accent-teal/20 rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { size: 16, className: "text-accent-teal" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body font-semibold text-sm text-inverse", children: "PDH Assistant" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-inverse/60 font-body", children: "Online · Replies instantly" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-3 min-h-0", children: [
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `w-6 h-6 rounded-full flex items-center justify-center shrink-0 ${msg.role === "bot" ? "bg-primary/10" : "bg-navy/10"}`,
                      children: msg.role === "bot" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { size: 12, className: "text-accent-teal" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 12, className: "text-muted-foreground" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `max-w-[80%] rounded-2xl px-3 py-2.5 text-sm font-body leading-relaxed ${msg.role === "bot" ? "bg-muted text-foreground rounded-bl-sm" : "bg-primary text-primary-foreground rounded-br-sm"}`,
            ...
            showFaqs && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 mt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-body pl-8", children: "Quick questions:" }),
              FAQ_QA.map((faq) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-t border-border flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
...
function ContactMap() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", className: "scroll-mt-24 mb-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl overflow-hidden shadow-card h-full min-h-64", children: [
...
function QualityPolicy() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "quality-policy", className: "scroll-mt-24 mb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-body font-semibold uppercase tracking-widest text-accent-teal mb-2", children: "Quality Policy" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl md:text-3xl text-foreground mb-3", children: "Our Commitment to Quality" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground max-w-lg", children: "Quality is not just a requirement — it is our culture and the foundation of every project we undertake." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-navy rounded-2xl p-8 mb-10 relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-48 h-48 bg-accent-teal/10 rounded-full translate-x-1/3 -translate-y-1/3" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-32 h-32 bg-primary/10 rounded-full -translate-x-1/3 translate-y-1/3" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col md:flex-row gap-6 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 bg-accent-teal/20 rounded-2xl flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 32, className: "text-accent-teal" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl text-inverse", children: "ISO 9001:2015 Certified" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-accent-teal/20 text-accent-teal px-2 py-0.5 rounded-full font-body", children: "CDG Certified" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-inverse/70 leading-relaxed max-w-xl", children: "PDH Tech Consultancy is ISO 9001:2015 certified by CDG Certification, demonstrating our adherence to international quality management standards. This certification is a testament to our systematic approach to quality in every process and deliverable." })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-6 shadow-card mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg text-foreground mb-5", children: "Quality Commitments" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: QUALITY_COMMITMENTS.map((commitment) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-muted-foreground leading-snug", children: commitment })
      ] }, commitment)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg text-foreground mb-5", children: "Registrations & Certifications" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4", children: CERTIFICATES.map(({ id, name, issuer, type }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          "data-ocid": id,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center mb-3 group-hover:bg-primary/20 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 16, className: "text-accent-teal" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-sm text-foreground mb-1", children: name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-xs text-muted-foreground mb-2", children: issuer }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs bg-muted text-muted-foreground px-2 py-0.5 rounded-full font-body", children: type })
          ]
        },
        id
      )) })
...
function WhyChooseUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "why-choose-us", className: "scroll-mt-24 mb-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-navy rounded-xl p-6 relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-inverse/80 leading-relaxed", children: "To be a globally recognized engineering consultancy renowned for innovation, quality, and customer-centric solutions that build a better world." })
        ] })
      ] }),
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(QualityPolicy, {}),
