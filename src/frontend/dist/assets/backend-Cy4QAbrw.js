...
Service({
  "createProject": Func(
    [Text, Text, Text, Text, Text, Vec(Text)],
    [ProjectItem],
    []
  ),
  "deleteProject": Func([Nat], [Bool], []),
  "getFeedbacks": Func([], [Vec(Feedback)], ["query"]),
  "getProjects": Func([], [Vec(ProjectItem)], ["query"]),
  "submitFeedback": Func([Text, Text, Text], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const ProjectItem2 = IDL2.Record({
    "id": IDL2.Nat,
    "client": IDL2.Text,
  ...
  return IDL2.Service({
    "createProject": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Vec(IDL2.Text)],
      [ProjectItem2],
      []
    ),
    "deleteProject": IDL2.Func([IDL2.Nat], [IDL2.Bool], []),
    "getFeedbacks": IDL2.Func([], [IDL2.Vec(Feedback2)], ["query"]),
    "getProjects": IDL2.Func([], [IDL2.Vec(ProjectItem2)], ["query"]),
...
class Backend {
  ...
  async createProject(arg0, arg1, arg2, arg3, arg4, arg5) {
